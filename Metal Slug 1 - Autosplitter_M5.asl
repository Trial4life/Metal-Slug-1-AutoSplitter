...
init
{
	...
	if(game.ProcessName.Equals("WinKawaks"))
	{
		...
		//The exclamation mark in the "Mission Start!" text of mission 5
...
;
		...
		//The black & yellow stripe in the base of the second wall, where the big tank spawns before the boss fight
		//Starts at pixel ( 286, 199 )
	...
	else //if(game.ProcessName.Equals("mslug1"))
	{
		...
		//The exclamation mark in the "Mission Start!" text of mission 5		// #TODO: The RGB values must be adapted for Steam
		//Starts at pixel ( 167 , 114 )
		vars.colorsRunStart = new byte[]		{
													66,  97,  123, 255,
													24,  56,  74,  255,
		...
		//The black & yellow stripe in the base of the second wall, where the big tank spawns before the boss fight		// #TODO: The RGB values must be adapted for Steam
		//Starts at pixel ( 286, 199 )
		vars.colorsBossStart = new byte[]		{
													99,  113, 123, 255,
													107, 138, 148, 255,
